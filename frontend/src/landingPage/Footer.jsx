  ...
  return (
    ...
    >
      <div className="container  mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <img
              ...
              style={{ width: "50%" }}
            />
            <p className="fs-8 text-muted mt-4">
              &copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col anchor">
        ...
        <div className="mt-5 fs-10 text-muted" style={{ fontSize: "0.75rem" }}>
          <p>
        ...
        <div className="d-flex justify-content-evenly anc mb-4">
          <a href="">NSE </a>
          <a href="">BSE </a>
          <a href="">MCX </a>
